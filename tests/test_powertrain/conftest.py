...
powertrain_snapshot_type_error_4 = [
    {'target_time': Time(1, 'sec'), 'angular_position_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_snapshot_type_error_5 = [
    {'target_time': Time(1, 'sec'), 'angular_speed_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_snapshot_type_error_6 = [
    {'target_time': Time(1, 'sec'), 'angular_acceleration_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_snapshot_type_error_7 = [
    {'target_time': Time(1, 'sec'), 'torque_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_snapshot_type_error_8 = [
    {'target_time': Time(1, 'sec'), 'driving_torque_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_snapshot_type_error_9 = [
    {'target_time': Time(1, 'sec'), 'load_torque_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_snapshot_type_error_10 = [
    {'target_time': Time(1, 'sec'), 'force_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_snapshot_type_error_11 = [
    {'target_time': Time(1, 'sec'), 'stress_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_snapshot_type_error_12 = [
    {'target_time': Time(1, 'sec'), 'current_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]
...
powertrain_snapshot_value_error_1 = [
    {'target_time': max(basic_powertrain.time) + Time(1, 'sec')}
]

powertrain_snapshot_value_error_2 = [
    {'target_time': min(basic_powertrain.time) - Time(1, 'sec')}
]

powertrain_snapshot_value_error_3 = [
    {'target_time': max(basic_powertrain.time), 'variables': []}
]

powertrain_snapshot_value_error_4 = [
    {
        'target_time': max(basic_powertrain.time),
        'variables': ['not a valid time variable']
    }
]
...
motor_not_in_basic_powertrain = DCMotor(
    name=basic_powertrain.elements[0].name + ' ',
...
powertrain_export_time_variables_type_error_1 = [
    {'folder_path': type_to_check} for type_to_check in types_to_check
    if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_2 = [
    {'folder_path': './test_data', 'time_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_3 = [
    {'folder_path': './test_data', 'angular_position_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_4 = [
    {'folder_path': './test_data', 'angular_speed_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_5 = [
    {'folder_path': './test_data', 'angular_acceleration_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_6 = [
    {'folder_path': './test_data', 'torque_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_7 = [
    {'folder_path': './test_data', 'driving_torque_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_8 = [
    {'folder_path': './test_data', 'load_torque_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_9 = [
    {'folder_path': './test_data', 'force_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_10 = [
    {'folder_path': './test_data', 'stress_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]

powertrain_export_time_variables_type_error_11 = [
    {'folder_path': './test_data', 'current_unit': type_to_check}
    for type_to_check in types_to_check if not isinstance(type_to_check, str)
]
