...
stop_condition_init_type_error_1 = [
    {
        'sensor': type_to_check,
        'threshold': Current(1, 'A'),
        'operator': StopCondition.greater_than
...
stop_condition_init_type_error_2 = [
    {
        'sensor': basic_amperometer,
        'threshold': type_to_check,
        'operator': StopCondition.greater_than
    } for type_to_check in types_to_check
...
stop_condition_check_condition_type_error_1 = [
    {'sensor_value': type_to_check, 'threshold': Current(1, 'A')}
    for type_to_check in types_to_check
    if not isinstance(type_to_check, UnitBase)
]

stop_condition_check_condition_type_error_2 = [
    {'sensor_value': Current(1, 'A'), 'threshold': type_to_check}
    for type_to_check in types_to_check
    if not isinstance(type_to_check, UnitBase)
]
