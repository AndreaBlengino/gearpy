...
from tests.conftest import types_to_check, basic_spur_gear_1, basic_spur_gear_2, basic_dc_motor_1, basic_dc_motor_2, \
    basic_flywheel, basic_worm_gear_1, basic_worm_gear_2, basic_worm_wheel_1, basic_worm_wheel_2
from pytest import fixture


basic_rotating_objects = [basic_dc_motor_1, basic_dc_motor_2, basic_spur_gear_1, basic_spur_gear_2, basic_flywheel,
