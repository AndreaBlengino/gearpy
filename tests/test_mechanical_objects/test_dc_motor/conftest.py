...
dc_motor_init_type_error_5 = [
    {
        ...
        'no_load_speed': AngularSpeed(1000, 'rpm'),
        'maximum_torque': Torque(1, 'Nm'),
        'no_load_electric_current': type_to_check,
...
dc_motor_init_type_error_6 = [
    {
        ...
        'maximum_electric_current': type_to_check
    } for type_to_check in types_to_check
    if not isinstance(type_to_check, Current) and type_to_check is not None
]
...
@fixture(
    params=[
        ...
        },
        {
            ...
            'no_load_speed': AngularSpeed(1000, 'rpm'),
            'maximum_torque': Torque(1, 'Nm'),
            'no_load_electric_current': Current(2, 'A'),
            'maximum_electric_current': Current(1, 'A')
        }
    ]
)
...
@fixture(
    params=[
        type_to_check for type_to_check in types_to_check
        if not isinstance(type_to_check, Current) and
...
@fixture(
    params=[
        ...
        and not isinstance(type_to_check, int) and
