...
@fixture(params=[*stress_init_type_error_1, *stress_init_type_error_2])
...
@fixture(
    params=[
        type_to_check for type_to_check in types_to_check
        if not isinstance(type_to_check, float | int | Stress)
    ]
)
...
@fixture(params=[*stress_to_type_error_1, *stress_to_type_error_2])
