...
from hypothesis.strategies import composite, sampled_from, floats
import numpy as np
...
@fixture(
    params=[*time_interval_init_type_error_1, *time_interval_init_type_error_2]
)
...
@fixture(
    params=[*time_interval_to_type_error_1, *time_interval_to_type_error_2]
)
