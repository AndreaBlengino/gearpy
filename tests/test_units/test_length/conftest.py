...
@fixture(params=[*length_init_type_error_1, *length_init_type_error_2])
...
@fixture(
    params=[
        ...
        if not isinstance(type_to_check, Length)
    ]
)
...
@fixture(params=[*length_to_type_error_1, *length_to_type_error_2])
