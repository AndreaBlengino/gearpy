...
@fixture(params=[*surface_init_type_error_1, *surface_init_type_error_2])
...
@fixture(
    params=[
        ...
        if not isinstance(type_to_check, Surface)
    ]
)
...
@fixture(params=[*surface_to_type_error_1, *surface_to_type_error_2])
