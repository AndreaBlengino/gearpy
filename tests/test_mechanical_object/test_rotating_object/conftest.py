...
from tests.conftest import types_to_check, basic_spur_gear_1, basic_spur_gear_2, basic_dc_motor, basic_flywheel
from pytest import fixture


basic_rotating_objects = [basic_dc_motor, basic_spur_gear_1, basic_spur_gear_2, basic_flywheel]
