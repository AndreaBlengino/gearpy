...
start_limit_current_init_type_error_1 = [
    {
        'encoder': type_to_check,
        'tachometer': basic_tachometer,
        'motor': basic_dc_motor_2,
        'target_angular_position': AngularPosition(1, 'rad'),
        'limit_electric_current': Current(1, 'A')
...
start_limit_current_init_type_error_5 = [
    {
        ...
        'motor': basic_dc_motor_2,
        'target_angular_position': AngularPosition(1, 'rad'),
        'limit_electric_current': type_to_check
    } for type_to_check in types_to_check
...
@fixture(
    params=[
        ...
        },
        {
            ...
            'motor': basic_dc_motor_2,
            'target_angular_position': AngularPosition(1, 'rad'),
            'limit_electric_current': Current(0, 'A')
        }
    ]
)
