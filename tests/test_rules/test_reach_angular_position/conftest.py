...
from tests.conftest import types_to_check, basic_powertrain, basic_encoder, basic_spur_gear_1, basic_dc_motor_1
...
reach_angular_position_init_type_error_1 = [{'encoder': type_to_check, 'powertrain': basic_powertrain,
...
reach_angular_position_init_type_error_2 = [{'encoder': basic_encoder, 'powertrain': type_to_check,
                                             'target_angular_position': AngularPosition(1, 'rad'),
                                             'braking_angle': Angle(1, 'rad')} for type_to_check in types_to_check
...
reach_angular_position_init_type_error_5 = [{'encoder': basic_encoder, 'powertrain': basic_powertrain,
                                             'target_angular_position': type_to_check, 'braking_angle': Angle(1, 'rad')}
                                            for type_to_check in types_to_check
                                            if not isinstance(type_to_check, AngularPosition)]

reach_angular_position_init_type_error_6 = [{'encoder': basic_encoder, 'powertrain': basic_powertrain,
                                             'target_angular_position': AngularPosition(1, 'rad'),
