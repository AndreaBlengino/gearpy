...
timer_init_type_error_1 = [{'start_time': type_to_check, 'duration': TimeInterval(5, 'sec')}
                           for type_to_check in types_to_check if not isinstance(type_to_check, Time)]

timer_init_type_error_2 = [{'start_time': Time(0, 'sec'), 'duration': type_to_check}
                           for type_to_check in types_to_check if not isinstance(type_to_check, Time)
                           and not isinstance(type_to_check, TimeInterval)]

@fixture(params = [*timer_init_type_error_1,
