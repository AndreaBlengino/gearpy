...
class HelicalGear(SpurGear):
    ...
    def helix_angle(self) -> Angle:
        """Helix angle of the helical gear. It must be an instance of :py:class:`Angle <gearpy.units.units.Angle>` lower
        than 90 degrees. \n
        Once set at the helical gear instantiation, it cannot be changed afterward.
        ...
        .. admonition:: Raises
           ...
           ``ValueError``
               If :py:attr:`helix_angle` is greater than or equal to 90 degrees.
        """
    ...
    def reference_diameter(self) -> Optional[Length]:
        ...
        It is computed as the product of :py:attr:`n_teeth` times :py:attr:`module` at the helical gear instantiation
    ...
    def lewis_factor(self) -> Optional[float]:
        ...
        number of gear teeth :py:attr:`n_teeth` and the :py:attr:`helix_angle`.
    ...
    def tangential_force_is_computable(self) -> bool:
        ...
        been set at helical gear instantiation, then it is possible to compute the tangential force and this property is
    ...
    def bending_stress_is_computable(self) -> bool:
        ...
        optional parameters have been set at helical gear instantiation, then it is possible to compute the bending
        stress and this property is ``True``, otherwise is ``False``.
    ...
    def contact_stress_is_computable(self) -> bool:
        ...
        :py:attr:`elastic_modulus`, so if these optional parameters have been set at helical gear instantiation, then it
        is possible to compute the contact stress and this property is ``True``, otherwise is ``False``.
